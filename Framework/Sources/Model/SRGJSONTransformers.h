...
OBJC_EXPORT NSValueTransformer *SRGAudioTrackSourceJSONTransformer(void);
OBJC_EXPORT NSValueTransformer *SRGAudioTrackTypeJSONTransformer(void);
...
OBJC_EXPORT NSValueTransformer *SRGSubtitleInformationSourceJSONTransformer(void);
OBJC_EXPORT NSValueTransformer *SRGSubtitleInformationTypeJSONTransformer(void);
