...
- (void)testLatestMediasForShowsWithURNs
{
    ...
    [[self.dataProvider latestMediasForShowsWithURNs:@[ @"urn:srf:show:tv:ff969c14-c5a7-44ab-ab72-14d4c9e427a9", @"urn:srf:show:c38cc259-b5cd-4ac1-b901-e3fddd901a3d", @"urn:srf:show:f65591cd-9f47-4264-abc0-7063f1a11159", @"urn:srf:show:c4b213cd-9790-0001-3063-e4001037ebe0Y" ] filter:SRGEpisodeFilterNone maximumPublicationDay:nil completionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
        [expectation1 fulfill];
    }] resume];
