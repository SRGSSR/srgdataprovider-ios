...
- (void)testResourcesForVideoOnDemand
{
    ...
    [[dataProvider mediaCompositionForURN:@"urn:rts:video:9116567" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSURLResponse * _Nullable response, NSError * _Nullable error) {
...
- (void)testResourcesForAudioOnDemand
{
    ...
    SRGDataProvider *dataProvider = [[SRGDataProvider alloc] initWithServiceURL:ServiceTestURL()];
    [[dataProvider mediaCompositionForURN:@"urn:rts:audio:9098092" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        SRGChapter *mainChapter = mediaComposition.mainChapter;
...
- (void)testMarkInMarkOutForVideoOnDemand
{
    ...
    [[dataProvider mediaCompositionForURN:@"urn:rts:video:9116567" standalone:YES withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        SRGChapter *mainChapter = mediaComposition.mainChapter;
