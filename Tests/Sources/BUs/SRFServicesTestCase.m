...
- (void)testFullLength
{
    ...
    [[self.dataProvider videoMediaCompositionWithUid:@"69e8ac16-4327-4af4-b873-fd5cd6e895a7" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
        XCTAssertNil(mediaComposition.fullLengthMedia.uid);
