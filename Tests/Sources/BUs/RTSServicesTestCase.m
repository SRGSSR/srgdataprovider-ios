...
- (void)testFullLength
{
    ...
    [[self.dataProvider audioMediaCompositionWithUid:@"a9e7621504c6959e35c3ecbe7f6bed0446cdf8da" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
        XCTAssertNil(mediaComposition.fullLengthMedia.uid);
