...
- (void)testTVLatestPrograms
{
    ...
    [[self.dataProvider tvLatestProgramsForVendor:SRGVendorRSI channelUid:kTVChannelUid fromDate:nil toDate:nil withCompletionBlock:^(SRGProgramComposition * _Nullable programComposition, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSHTTPURLResponse * _Nullable HTTPResponse, NSError * _Nullable error) {
