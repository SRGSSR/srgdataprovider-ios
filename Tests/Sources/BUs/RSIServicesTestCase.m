...
static NSString * const kRadioShowUid = @"3520594";
static NSString * const kRadioShowOtherUid = @"2720638";
...
static NSString * const kTVShowUid = @"2311780";
static NSString * const kTVShowOtherUid = @"2005463";
static NSString * const kTVShowSearchQuery = @"telegiornale";

static NSString * const kOnlineShowUid = @"6104365";
static NSString * const kOnlineShowOtherUid = @"6354550";
...
- (void)setUp
{
    self.dataProvider = [[SRGDataProvider alloc] initWithServiceURL:SRGIntegrationLayerProductionServiceURL() businessUnitIdentifier:SRGDataProviderBusinessUnitRSI];
}
...
- (void)testTVScheduledLivestreams
{
    ...
    [[self.dataProvider tvScheduledLivestreamsWithCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
        [expectation fulfill];
    }] resume];
...
- (void)testRadioLivestreamsForContentProviders
{
    ...
    [[self.dataProvider radioLivestreamsForContentProviders:SRGContentProvidersDefault withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
        [expectation1 fulfill];
    }] resume];
    ...
    [[self.dataProvider radioLivestreamsForContentProviders:SRGContentProvidersAll withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
        [expectation2 fulfill];
    }] resume];
    ...
    [[self.dataProvider radioLivestreamsForContentProviders:SRGContentProvidersSwissSatelliteRadio withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, NSError * _Nullable error) {
        XCTAssertNotNil(medias);
        XCTAssertNil(error);
...
- (void)testFullLength
{
    ...
    // Full-length VOD
    [[self.dataProvider videoMediaCompositionWithUid:@"8950717" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
    ...
    [[self.dataProvider videoMediaCompositionWithUid:@"9014449" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
        XCTAssertEqualObjects(mediaComposition.fullLengthMedia.uid, @"8950717");
        [expectation2 fulfill];
    }] resume];
    ...
    [[self.dataProvider videoMediaCompositionWithUid:@"9016660" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
    ...
    [[self.dataProvider videoMediaCompositionWithUid:@"livestream_La1" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
    ...
    [[self.dataProvider audioMediaCompositionWithUid:@"8923771" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
    ...
    [[self.dataProvider audioMediaCompositionWithUid:@"livestream_ReteUno" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
