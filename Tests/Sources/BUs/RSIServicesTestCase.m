...
- (void)testTVEditorialShows
{
    ...
    [[self.dataProvider tvEditorialShowsForVendor:SRGVendorRSI firstCharacter:nil withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
    ...
    [[self.dataProvider tvEditorialShowsForVendor:SRGVendorRSI firstCharacter:@"a" withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(shows);
        XCTAssertNil(error);
        [expectation2 fulfill];
    }] resume];
    ...
    [[self.dataProvider tvEditorialShowsForVendor:SRGVendorRSI firstCharacter:@"#" withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(shows);
        XCTAssertNil(error);
    ...
    [[self.dataProvider tvEditorialShowsForVendor:SRGVendorRSI firstCharacter:@"ab" withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
...
- (void)testRadioEditorialShows
{
    ...
    [[self.dataProvider radioEditorialShowsForVendor:SRGVendorRSI channelUid:kRadioChannelUid firstCharacter:nil withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(shows);
        XCTAssertNil(error);
        [expectation1 fulfill];
    }] resume];
    ...
    [[self.dataProvider radioEditorialShowsForVendor:SRGVendorRSI channelUid:kRadioChannelUid firstCharacter:@"a" withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(shows);
        XCTAssertNil(error);
        [expectation2 fulfill];
    }] resume];
    ...
    [[self.dataProvider radioEditorialShowsForVendor:SRGVendorRSI channelUid:kRadioChannelUid firstCharacter:@"#" withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(shows);
        XCTAssertNil(error);
        [expectation3 fulfill];
    }] resume];
    ...
    [[self.dataProvider radioEditorialShowsForVendor:SRGVendorRSI channelUid:kRadioChannelUid firstCharacter:@"ab" withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        [expectation4 fulfill];
    }] resume];
...
- (void)testRadioShows
{
    ...
    [[self.dataProvider radioShowsForVendor:SRGVendorRSI withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        [expectation fulfill];
    }] resume];
...
- (void)testVideosWithTags
{
    ...
    [[self.dataProvider videosForVendor:SRGVendorRSI withTags:@[kTag1] excludedTags:nil fullLengthExcluded:YES completionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        [expectation1 fulfill];
    }] resume];
    ...
    [[self.dataProvider videosForVendor:SRGVendorRSI withTags:@[kTag1] excludedTags:@[kTag1] fullLengthExcluded:YES completionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        [expectation2 fulfill];
    }] resume];
    ...
    [[self.dataProvider videosForVendor:SRGVendorRSI withTags:@[kTag1, kTag2] excludedTags:nil fullLengthExcluded:YES completionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        [expectation3 fulfill];
    }] resume];
    ...
    [[self.dataProvider videosForVendor:SRGVendorRSI withTags:@[kTag1] excludedTags:nil fullLengthExcluded:NO completionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        [expectation4 fulfill];
    }] resume];
    ...
    [[self.dataProvider videosForVendor:SRGVendorRSI withTags:@[] excludedTags:nil fullLengthExcluded:YES completionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
...
- (void)testRecommendedVideos
{
    ...
    [[self.dataProvider recommendedVideosForVendor:SRGVendorRSI uid:kVideoUid userId:nil withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        [expectation1 fulfill];
    }] resume];
    ...
    [[self.dataProvider recommendedVideosForVendor:SRGVendorRSI uid:kVideoUid userId:kUserId withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNotNil(error);
        [expectation2 fulfill];
    }] resume];
...
- (void)testRecommendedTVShows
{
    ...
    [[self.dataProvider recommendedTvShowsForVendor:SRGVendorRSI userId:kUserId withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        XCTAssertNil(shows);
        XCTAssertNotNil(error);
        [expectation fulfill];
    }] resume];
...
- (void)testFullLength
{
    ...
    // Full-length VOD
    [[self.dataProvider mediaCompositionForURN:@"urn:rsi:video:8950717" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
    ...
    [[self.dataProvider mediaCompositionForURN:@"urn:rsi:video:9014449" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
        XCTAssertEqualObjects(mediaComposition.fullLengthMedia.uid, @"8950717");
        [expectation2 fulfill];
    }] resume];
    ...
    [[self.dataProvider mediaCompositionForURN:@"urn:rsi:video:9016660" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
    ...
    [[self.dataProvider mediaCompositionForURN:@"urn:rsi:video:livestream_La1" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
    ...
    [[self.dataProvider mediaCompositionForURN:@"urn:rsi:audio:8923771" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
    ...
    [[self.dataProvider mediaCompositionForURN:@"urn:rsi:audio:livestream_ReteUno" standalone:NO withCompletionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
