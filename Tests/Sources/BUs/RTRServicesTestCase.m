...
- (void)testFullLength
{
    ...
    [[self.dataProvider videoMediaCompositionWithUid:@"12fb886e-b7aa-4e55-beb2-45dbc619f3c4" chaptersOnly:NO completionBlock:^(SRGMediaComposition * _Nullable mediaComposition, NSError * _Nullable error) {
        XCTAssertNil(mediaComposition.fullLengthMedia.uid);
