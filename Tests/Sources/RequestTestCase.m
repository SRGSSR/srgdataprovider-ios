...
{
    // Default page size
    SRGFirstPageRequest *request1 = [self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
    ...
    // Specific page size
    SRGFirstPageRequest *request2 = [[self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        // Nothing, the request isn't run
    ...
    __block SRGPageRequest *request3 = [[self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        // Nothing, the request isn't run
    }] requestWithPage:nil];
    ...
    // Incorrect page size
    SRGFirstPageRequest *request4 = [[self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        // Nothing, the request isn't run
    ...
    SRGFirstPageRequest *request5 = [[self.dataProvider tvEditorialMediasForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        // Nothing, the request isn't run
    ...
    SRGFirstPageRequest *request6 = [[[self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        // Nothing, the request isn't run
...
- (void)testDeallocation
{
    ...
    @autoreleasepool {
        request1 = [self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
    ...
    @autoreleasepool {
        request3 = [self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
...
#pragma clang diagnostic ignored "-Warc-unsafe-retained-assign"
    ...
    @autoreleasepool {
        ...
        SRGRequest *request = [dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
...
- (void)testStatus
{
    ...
    __block SRGRequest *request = [self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
...
- (void)testPageInformation
{
    ...
    __block SRGFirstPageRequest *request = [[self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
...
- (void)testSupportedUnlimitedPageSize
{
    ...
    __block SRGFirstPageRequest *request = [[self.dataProvider tvShowsForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGShow *> * _Nullable shows, SRGPage * _Nonnull page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
...
- (void)testRunningKVO
{
    SRGRequest *request = [self.dataProvider tvLatestEpisodesForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
        // Nothing
    }];
...
- (void)testNestedRequests
{
    ...
    SRGRequest *request1 = [self.dataProvider tvEditorialMediasForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
...
- (void)testPageSizeOverrideTwice
{
    ...
    __block SRGRequest *request = [[[self.dataProvider tvEditorialMediasForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
...
- (void)testPages
{
    ...
    __block SRGFirstPageRequest *request = [[self.dataProvider tvEditorialMediasForBusinessUnit:SRGDataProviderBusinessUnitSWI withCompletionBlock:^(NSArray<SRGMedia *> * _Nullable medias, SRGPage *page, SRGPage * _Nullable nextPage, NSError * _Nullable error) {
