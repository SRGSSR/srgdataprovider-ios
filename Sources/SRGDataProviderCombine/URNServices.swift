...
public extension SRGDataProvider {
     ...
     */
    func medias(withUrns urns: [String], pageSize: UInt = SRGDataProviderDefaultPageSize, triggerId: Trigger.Id? = nil) -> AnyPublisher<[SRGMedia], Error> {
        let request = requestMedias(withURNs: urns)
        return paginatedObjectsTriggeredPublisher(at: URNPage(originalRequest: request, queryParameter: "urns", size: pageSize), rootKey: "mediaList", type: SRGMedia.self, triggerId: triggerId)
    }
     ...
     */
    func latestMediasForTopic(withUrn topicUrn: String, pageSize: UInt = SRGDataProviderDefaultPageSize, triggerId: Trigger.Id? = nil) -> AnyPublisher<[SRGMedia], Error> {
     ...
     *  - Parameter topicURN: The unique topic URN.
     */
    func mostPopularMediasForTopic(withUrn topicUrn: String, pageSize: UInt = SRGDataProviderDefaultPageSize, triggerId: Trigger.Id? = nil) -> AnyPublisher<[SRGMedia], Error> {
     ...
     *  from different business units.
     */
    func shows(withUrns urns: [String], pageSize: UInt = SRGDataProviderDefaultPageSize, triggerId: Trigger.Id? = nil) -> AnyPublisher<[SRGShow], Error> {
        let request = requestShows(withURNs: urns)
        return paginatedObjectsTriggeredPublisher(at: URNPage(originalRequest: request, queryParameter: "urns", size: pageSize), rootKey: "showList", type: SRGShow.self, triggerId: triggerId)
    }
     ...
     */
    func latestEpisodesForShow(withUrn showUrn: String, maximumPublicationDay: SRGDay? = nil, pageSize: UInt = SRGDataProviderDefaultPageSize, triggerId: Trigger.Id? = nil) -> AnyPublisher<LatestEpisodesForShow.Output, Error> {
        let request = requestLatestEpisodesForShow(withURN: showUrn, maximumPublicationDay: maximumPublicationDay)
        return paginatedObjectTriggeredPublisher(at: Page(request: request, size: pageSize), type: SRGEpisodeComposition.self, triggerId: triggerId)
     ...
     */
    func latestMediasForShow(withUrn showUrn: String, pageSize: UInt = SRGDataProviderDefaultPageSize, triggerId: Trigger.Id? = nil) -> AnyPublisher<[SRGMedia], Error> {
     ...
     *  - Parameter maximumPublicationDay: If not `nil`, medias up to the specified day are returned.
     */
    func latestMediasForShows(withUrns urns: [String], filter: SRGMediaFilter = .none, maximumPublicationDay: SRGDay? = nil, pageSize: UInt = SRGDataProviderDefaultPageSize, triggerId: Trigger.Id? = nil) -> AnyPublisher<[SRGMedia], Error> {
     ...
     */
    func latestMediasForModule(withUrn moduleUrn: String, pageSize: UInt = SRGDataProviderDefaultPageSize, triggerId: Trigger.Id? = nil) -> AnyPublisher<[SRGMedia], Error> {
